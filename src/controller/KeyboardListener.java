 ...
 * instantiates it.
 *
 * <p>This listener keeps three maps, one each for key typed, key pressed and key released
 ...
 *
 * <p>This class implements the KeyListener interface, so that its object can be used as a
